...
2. Goto **Settings** tab, scroll down to **Other** section, selected **Enable SwiftStack Swift Cluster Integration** and fill up all parameters Swift API IP Address: ``192.168.1.100``
...
erify Swift cluster, Keystone and Glance integration through Swift cli
======================================================================
